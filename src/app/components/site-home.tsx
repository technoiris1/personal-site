        ...
        <div className="frame-content">
          ...
          <section id="home" className="intro-copy" aria-labelledby="intro-title">
            ...
            <div id="things" className="bio-copy">
              <p>im a high schooler from india. i properly got my hands a computer when i was around 10 (i think), since then computers have been a huge part of my life.</p>
              <p>i've been incredibly lucky for being able to get access to such an amazing technology. it started with playing games like minecraft, but after a while i got bored of the handful of games my machine could run. so one random day i decided to dive into how these things actually work. i still remember the first thing i came across was an ASCII character sheet, i just wanted to see what makes the player move forward when i press W.   </p>
              <p>i believe people can do great things when they come together, it used to be quite hard to do that a couple of decades ago, but now it's a lot more easier, credits to the advent of widely accessible technology. online communities shaped me and my life, and i try to make similar environment for other kids around me, for them to learn and create.</p>
              <p>
