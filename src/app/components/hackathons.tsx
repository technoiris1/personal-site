...
export default function Hackathons({ className = '' }: HackathonsProps){
    ...
    <p className="hero-name text-5xl tracking-normal text-[#201d15]">TBD</p>
    </div>
    <div className="flex-1 pt-4 pl-8">
        <p className="text-[#201d15]" style={{ fontFamily: 'var(--font-montserrat)', fontWeight: '550' }}>lalalalalalalalalalalalalalalalalalaalalalalalall</p>
        </div>
    </div>)}